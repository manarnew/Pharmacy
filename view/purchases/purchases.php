        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <a class="btn btn-info float-right" href="add.php"><i class="fas fa-plus"></i> Add Purchase</a>
                    ...
                    <td><?php $i++;echo $i; ?></td>
                      ...
                      <td>
                        <?php if ($row['approved'] != 1) : ?>
                          <a href="../../includes/purchaseOpration.php?deletePurchaseId=<?php echo $row['purchaseId']; ?>" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                          <a href="../../includes/purchaseOpration.php?approveId=<?php echo $row['purchaseId']; ?>" class="btn btn-success"><i class="fas fa-check-circle"></i> Approve</a>
