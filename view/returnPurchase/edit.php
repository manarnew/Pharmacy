            ...
            <div class=" card-body">
              <form class="form-horizontal" method="post" action="/pharmacyapp/includes/productOpration.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="controls">
                    <div class="input-prepend input-group">
                      <input id="prependedInput" value="<?php echo $pro['batchNumber']; ?>" class="form-control" size="16" type="text" name="batchNumber">
                    </div>
                  </div>
                </div>
                    ...
                    <div class="input-group">
                      <select id="select" name="supplierId" class="form-control" size="1" required>
                        ...
                        <?php foreach ($sup as $supp) :
                          if ($supp['supplierId'] == $pro['supplierId']) {
                          } else {
                        ?>
                ...
                <div class="row">
                  <div class=" col-sm-6">
                    ...
                    <div class="form-group">
                      ...
                      <div class="controls">
                        <div class="input-prepend input-group">
                          <input id="WholesaleQty" value="<?php echo $pro['WholesaleQty']; ?>" class="form-control" size="16" type="number" name="WholesaleQty" required>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group showUnit" style="display: none;">
                      ...
                      <div class="controls">
                        <div class="input-prepend input-group">
                          <input id="RetailSalePrice" readonly value="<?php echo $pro['RetailSalePrice']; ?>" class="form-control" size="16" type="number" name="RetailSalePrice">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group showUnit" style="display: none;">
                      ...
                      <div class="controls">
                        <div class="input-prepend input-group">
                          <input id="RetailQty" class="form-control" value="<?php echo $pro['RetailQty']; ?>" size="16" type="number" name="RetailQty">
                          <input id="TotalRetailQty" class="form-control" value="<?php echo $pro['TotalRetailQty']; ?>" size="16" type="hidden" name="TotalRetailQty">
                        </div>
                      </div>
                    </div>
